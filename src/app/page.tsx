        ...
        <section className="mt-10 rounded-3xl border border-[var(--border-color)] bg-[var(--surface-2)] p-6 sm:p-8 transition-colors duration-200">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {[
              ...
              { icon: <Sparkles className="h-5 w-5 text-pink-400" />, title: 'Premium UX', desc: 'Animated transitions, polished forms, and responsive interactions across devices.' },
            ].map(({ icon, title, desc }) => (
        ...
        <section className="mt-10 rounded-3xl border border-[var(--border-color)] bg-[var(--surface-2)] p-6 sm:p-8 transition-colors duration-200">
          ...
          <div className="mt-6 space-y-3">
            {[
              ...
              { q: 'Do I need a previously logged-in device to recover my master password?', a: 'No. Master password recovery works from any device or browser. You only need your email address and account password. The encrypted recovery blob is stored in the cloud (Firestore), so it is accessible from anywhere as long as you can authenticate with your account credentials.' },
